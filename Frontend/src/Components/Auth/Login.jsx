...
const Login = ({setToggle}) => {
  ...
  return (
   ...
   <Button isLoading={loading} variant='solid' colorScheme='purple' onClick={submitHandler}>Login</Button> 
   </form>
   <div className={style.formobile}>
    <Text mt='20px'>Don't have an account?<span onClick={()=>setToggle(true)}>Signup</span></Text>
   </div>
    </div>
  )
}
